window.AD_BLOCK_TEST_DATA = Object.freeze({
    ...
    sources: [
        ...
        { id: '1hosts', name: '1Hosts', url: 'https://github.com/badmojr/1Hosts', note: 'Bộ DNS blocklist lớn, tối ưu cho privacy, malware và clean browsing.' },
        { id: 'adaway-hosts', name: 'AdAway Hosts', url: 'https://github.com/AdAway/adaway.github.io', note: 'Hosts list chính thức của AdAway, cập nhật cho ad/tracker ở mức hệ thống.' },
        { id: 'peter-lowe', name: 'Peter Lowe Blocklist', url: 'https://pgl.yoyo.org/adservers/', note: 'Danh sách ad/tracking lâu năm, được dùng rộng rãi trong nhiều trình chặn.' },
        { id: 'someonewhocares', name: 'SomeoneWhoCares Hosts', url: 'https://someonewhocares.org/hosts/', note: 'Hosts file lâu năm, tập trung chặn ads, trackers và spammy domains.' },
        { id: 'disconnect', name: 'Disconnect Tracking Protection', url: 'https://github.com/disconnectme/disconnect-tracking-protection', note: 'Nguồn tracker protection nổi tiếng, được nhiều trình duyệt và công cụ privacy tham chiếu.' },
        { id: 'duckduckgo-radar', name: 'DuckDuckGo Tracker Radar', url: 'https://github.com/duckduckgo/tracker-radar', note: 'Dataset metadata lớn về third-party trackers và fingerprinting trên web.' },
        ...
        { id: 'phishtank', name: 'PhishTank', url: 'https://www.phishtank.com/', note: 'Cơ sở dữ liệu phishing cộng đồng, thường được dùng để đối chiếu URL giả mạo.' },
        { id: 'openphish', name: 'OpenPhish', url: 'https://openphish.com/phishing_feeds.html', note: 'Nguồn phishing feed thương mại/cộng đồng, cập nhật nhanh cho URL giả mạo.' },
