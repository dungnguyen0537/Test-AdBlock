window.AD_BLOCK_TEST_DATA = Object.freeze({
    ...
    sources: [
        { id: 'easylist', name: 'EasyList / EasyPrivacy', url: 'https://easylist.to/', note: 'Nguồn nền cho nhiều browser blocker và tracking feed hiện nay.' },
        { id: 'hostlistsregistry', name: 'AdGuard HostlistsRegistry', url: 'https://github.com/AdguardTeam/HostlistsRegistry', note: 'Kho phân phối mà nhiều filter trong ảnh đang được đóng gói để dùng trực tiếp.' },
        { id: 'adguard-filter', name: 'AdGuard DNS Filter', url: 'https://adguardteam.github.io/AdGuardSDNSFilter/Filters/filter.txt', note: 'Danh sách DNS filter chính thức của AdGuard.' },
        { id: '1hosts', name: '1Hosts (Lite / Xtra)', url: 'https://badmojr.gitlab.io/1hosts/', note: 'Bộ blocklist lớn cho ad, tracker, badware và clean browsing.' },
        { id: 'oisd', name: 'OISD (Small / Big)', url: 'https://oisd.nl/', note: 'Hệ blocklist tổng hợp phổ biến cho quảng cáo, tracker, telemetry và spam.' },
        { id: 'hagezi', name: 'HaGeZi DNS Blocklists', url: 'https://github.com/hagezi/dns-blocklists', note: 'Bao gồm multi, TIF, tracker, telemetry, popup, badware và nhiều list chuyên biệt.' },
        { id: 'awavenue', name: 'AWAvenue Ads Rule', url: 'https://github.com/TG-Twilight/AWAvenue-Ads-Rule', note: 'Danh sách chặn quảng cáo được dùng phổ biến trong AdGuard Home và DNS filter.' },
        { id: 'dan-pollock', name: 'Dan Pollock\'s List', url: 'https://someonewhocares.org/hosts/', note: 'Hosts list lâu năm, thường được nhắc cùng Peter Lowe và các DNS blocklist cổ điển.' },
        { id: 'peter-lowe', name: 'Peter Lowe Blocklist', url: 'https://pgl.yoyo.org/adservers/', note: 'Danh sách ad/tracking lâu năm, thường xuất hiện trong nhiều bộ lọc tổng hợp.' },
        { id: 'dandelionsprout', name: 'Dandelion Sprout Lists', url: 'https://github.com/DandelionSprout/adfilt', note: 'Gồm anti-push, anti-malware, Smart-TV, NoCoin và nhiều filter chuyên đề.' },
        { id: 'shadowwhisperer', name: 'ShadowWhisperer BlockLists', url: 'https://github.com/ShadowWhisperer/BlockLists', note: 'Nguồn tracking, malware và dating/special-interest blocklists.' },
        { id: 'windowsspyblocker', name: 'WindowsSpyBlocker', url: 'https://crazymax.dev/WindowsSpyBlocker/blocking-rules/hosts/', note: 'Nguồn chặn telemetry/spying cho Windows và dịch vụ liên quan.' },
        { id: 'stevenblack', name: 'Steven Black Hosts', url: 'https://github.com/StevenBlack/hosts', note: 'Tổng hợp hosts file nổi tiếng cho ads, malware và porn filters.' },
        { id: 'phishing-url-blocklist', name: 'PhishTank / OpenPhish', url: 'https://openphish.com/phishing_feeds.html', note: 'Nguồn phishing feed để rút mẫu cho nhóm malware/phishing.' },
        { id: 'urlhaus', name: 'URLHaus / abuse.ch', url: 'https://urlhaus.abuse.ch/', note: 'Nguồn URL phát tán malware và payload delivery.' },
        { id: 'phishing-army', name: 'Phishing Army', url: 'https://phishing.army/', note: 'Blocklist chuyên phishing, credential theft và lookalike sites.' },
        { id: 'stalkerware', name: 'Stalkerware Indicators', url: 'https://github.com/AssoEchap/stalkerware-indicators', note: 'Danh sách IOC/domain liên quan stalkerware và spyware.' },
        { id: 'durablenapkin', name: 'DurableNapkin Scam Blocklist', url: 'https://github.com/DurableNapkin/scamblocklist', note: 'Nguồn tập trung vào scam, lừa đảo và landing pages độc hại.' },
        { id: 'amtso', name: 'AMTSO', url: 'https://www.amtso.org/', note: 'Trang kiểm tra an toàn cho URL filtering và web security.' }
    ],
    controls: [
